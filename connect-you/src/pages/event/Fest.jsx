...
const Fest = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState("Fest");
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          //console.log(data)
          setEvent(data);
          // Filter events for "Fest" by default
      const festEvents = data.filter((ev) => ev.category === "Fest");
      setFilteredEvents(festEvents);
      setSelectedCategory("Fest"); // Set the selected category to "Fest"
        } catch (error) {
