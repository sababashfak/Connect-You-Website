    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          //console.log(data)
          setEvent(data);
          // Filter events for "Seminar" by default
          const seminarEvents = data.filter((ev) => ev.category === "Seminar");
          setFilteredEvents(seminarEvents);
          setSelectedCategory("Seminar"); // Set the selected category to "Reunion"
        } catch (error) {
