    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          //console.log(data)
          setEvent(data);
          // Filter events for "Skill" by default
          const skillEvents = data.filter((ev) => ev.category === "Skill Development");
          setFilteredEvents(skillEvents);
          setSelectedCategory("Skill Development"); // Set the selected category to "Skill"
        } catch (error) {
