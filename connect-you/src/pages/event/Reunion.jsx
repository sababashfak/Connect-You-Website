...
const Reunion = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState("Reunion");
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          //console.log(data)
          // Filter events for "Reunion" by default
          const reunionEvents = data.filter((ev) => ev.category === "Reunion");
          setFilteredEvents(reunionEvents);
          setSelectedCategory("Reunion"); // Set the selected category to "Reunion"
        } catch (error) {
