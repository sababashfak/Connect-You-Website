...
const Expo = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState("Expo");
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          //console.log(data)
          setEvent(data);
          // Filter events for "Expo" by default
          const expoEvents = data.filter((ev) => ev.category === "Expo");
          setFilteredEvents(expoEvents);
          setSelectedCategory("Expo"); // Set the selected category to "Expo"
        } catch (error) {
