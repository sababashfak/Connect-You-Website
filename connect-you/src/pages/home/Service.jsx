      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <button className='btn bg-orange text-white px-8 py-9 rounded-full'>Get More Info</button>
          </div>
        </div>
            ...
            <div className='grid sm:grid-cols-2 grid-cols-1 gap-8 items-center'>
                {
                    serviceLists.map((service) => (
                        <div key={service.id} className='shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-orange cursor-pointer hover:border-in duration-200 hover:border'>
